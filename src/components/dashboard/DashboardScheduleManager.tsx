...
import { saveOwnScheduleAction, deleteOwnScheduleAction } from "@/app/(site)/dashboard/actions";
...
export default function DashboardScheduleManager({ schedules }: { schedules: TruckSchedule[] }) {
  ...
  const handleAdd = async () => {
    ...
    await saveOwnScheduleAction(null, fd);
    setDraft(emptyDraft);
    setSubmitting(false);
  };
              ...
              <div className="mt-2 space-y-2">
                {entries.map((e) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() => deleteOwnScheduleAction(e.id)}
